...
import { TripBriefSlice } from '../features/trip-brief/TripBriefSlice';
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <header className="mx-auto flex max-w-7xl items-center justify-between px-6 py-6">
        ...
        <a className="rounded-full border border-white/15 px-5 py-2 text-sm text-slate-200" href="#assistant">
          Start planning
        </a>
      </header>
      ...
      <main>
        <section className="mx-auto grid max-w-7xl gap-10 px-6 py-20 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div>
            ...
            <h2 className="mt-6 max-w-4xl text-5xl font-black tracking-tight text-white md:text-7xl">
      ...
      <footer className="border-t border-white/10 px-6 py-8 text-center text-sm text-slate-500">
        Travel Buddy Assistant AI — foundation build.
      </footer>
    </div>
  );
}
